                    ...
                    <div className="relative z-10 max-w-4xl mx-auto px-6 w-full text-center">
                        ...
                        >
                            ...
                            <p className="text-lg md:text-xl text-slate-600 tracking-tight max-w-2xl mx-auto leading-relaxed mt-6">
                                At QuillsStroke, our mission is to ensure that no patient feels abandoned after leaving the hospital. We bridge the gap between hospital and home, delivering continuous, AI-driven care that saves lives and reduces medical burdens.
                            </p>
