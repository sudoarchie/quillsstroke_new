      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <p className="text-white/60 font-mono text-xs max-w-xl mx-auto leading-relaxed">
            QuillsStroke is a 360° post-discharge care and retention system that automates patient follow-up using clinical AI workflows while generating new revenue streams without adding staff.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <span className="text-xl font-black">
              <span className="text-white">Quills</span>
              <span className="text-green-400">Stroke</span>
            </span>
          </motion.div>

          <p className="text-white/40 font-mono text-xs">© 2026 QuillsStroke. All rights reserved.</p>
